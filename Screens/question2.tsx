...
const Question2 = () => {
    ...
    const navigator = useNavigation<NativeStackNavigationProp<ScreenParamTypes, 'Question2'>>()
        ...
        <SafeAreaView style={styles.appContainer}>
            ...
            <View style={{ flex: 1, flexDirection: 'column' }}>
                <View style={styles.question}>
                    <Text style={styles.textStyle}>{data.question2.question}</Text>
                </View>
                <FlatList
                    // style={{flex:0.5}}
                    data={data.question2.options}
                    renderItem={({ item }) => (
                        <Card style={{ margin: 5 }}>
                            <View style={styles.card}>
                                <TouchableOpacity
                                    ...
                                    onPress={() => handlePress(data.question2.id, item.corw)}>
